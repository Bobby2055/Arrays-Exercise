...
while (true)
{
    ...
    if (lenght > currentSequneceLength || lenght == currentSequneceLength && currentStartingIndex > startingIndex || lenght == currentStartingIndex && currentStartingIndex == startingIndex && sum > currentSum)
    {
        currentLongestSequence = array;
        currentSequneceLength = lenght;
